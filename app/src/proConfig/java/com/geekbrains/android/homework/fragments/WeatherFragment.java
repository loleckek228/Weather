...
public class WeatherFragment extends Fragment {
    ...
    private void readFromPreference(SharedPreferences preferences) {
        ...
        if (city.equals(getString(R.string.city))) {
            ...
            String cityName = LocationFinder.getInstance().getCityByLocation(location.getLatitude(), location.getLongitude());

            RetrievesWeatherData.getInstance().updateWeatherData(cityName, true);
        }
